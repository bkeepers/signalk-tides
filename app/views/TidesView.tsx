  ...
  return (
    <>
      <header className="p-6 mb-8 flex gap-8">
        ...
        <div>
          <a href={SETTINGS_URL}>
            <svg className="size-5 stroke-white/70 hover:stroke-white transition-colors" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5}>
...
export function LoadingTidesView() {
  return (
    <div className="flex-1 flex flex-col gap-6 items-center justify-center animate-pulse">
      <svg aria-hidden="true" className="size-20 animate-spin dark:text-white/20 fill-white/60" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
